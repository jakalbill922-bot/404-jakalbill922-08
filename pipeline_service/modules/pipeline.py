...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        # generate back view
        image_back_view = self.qwen_edit.edit_image(prompt_image=image_without_background, seed=request.seed, prompt="Show back view of the object")

        image_back_view_without_background = self.rmbg.remove_background(image_back_view)
        ...
        trellis_result = self.trellis.generate(
            TrellisRequest(
                images=[image_without_background, image_back_view_without_background],
                seed=request.seed,
